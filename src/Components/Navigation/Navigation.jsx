    ...
    <nav className="flex gap-3 p-3 bg-gray-100 justify-around items-center">
      ...
      <div className="w-2/5 flex gap-10 items-center justify-start">
        ...
        <div className="hidden sm:flex gap-1 w-full">
          <input className="w-full focus:outline-none focus:ring rounded-full py-2 px-5" placeholder="Search products..." />
      ...
      <div className="flex gap-3 items-center">
        <Link to="/signin" className="border border-black rounded-2xl py-0.5 px-3 hover:opacity-60">
          Sign in
        </Link>
        <Link to="/signup" className="border border-black rounded-2xl py-0.5 px-3 hover:opacity-60">
          Sign up
        </Link>
      </div>
    </nav>
